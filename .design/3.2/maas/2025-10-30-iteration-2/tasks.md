...
This document contains a running list of implementation tasks for the second major iteration of the MaaS UI, with items pulled from the relevant Jira sources of the design-sources.md file as of this approximate date.
